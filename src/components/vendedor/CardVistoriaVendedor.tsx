          ...
          <div className="mt-6 flex flex-col sm:flex-row gap-3">
            {v.status === 'AGUARDANDO_CONFIRMACAO' ? (
              <>
               ...
               <div className="flex items-center gap-2 text-teal-700 font-bold text-sm bg-teal-50 px-4 py-3 rounded-xl border border-teal-100 w-full justify-center">
                  <CheckCircle2 className="h-4 w-4" /> Vistoria confirmada! Esperamos você.
               </div>
            ) : (
